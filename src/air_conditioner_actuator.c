...
void *runPublisher(void *args){
	...
	log_file = fopen("/tmp/air_conditioner_actuator_publisher.log", "w");
	logString(log_file, "Starting air conditioner actuator publisher");
...
void *runServer(void *args){
	...
	//set up log file
	log_file = fopen("/tmp/air_conditioner_actuator_server.log", "w");
	logString(log_file, "Starting air conditioner actuator server");
